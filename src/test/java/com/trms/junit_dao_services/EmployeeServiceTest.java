...
public class EmployeeServiceTest {
	...
	static EmployeeService rs = new EmployeeServiceImpl(dao);
		...
		public void e_updateEmployeeTest() {
			...
			updatedEmpId = updateEmployee.getEmpId();
		...
		public static void tearDown() throws Exception {
			...
			Employee r5updated = dao.deleteEmployee(updatedEmpId);
			System.out.println("deleted " + newId);
			System.out.println("deleted" + updatedEmpId);
		}
}
